<?php namespace App\Http\Controllers;
	...
	class AdminToolsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"No Of Tooling","name"=>"no_of_tooling","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Start Value","name"=>"start_value","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Guarantee Shoot","name"=>"guarantee_shoot","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Delivery Date","name"=>"delivery_date","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Start Value Date","name"=>"start_value_date","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
